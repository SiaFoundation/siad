...
default duration of 10 minutes will be used.

### Path Parameters
#### OPTIONAL 
**duration** | string  
duration is how long the repairs and uploads will be paused. The API accepts
string values in the form of `10m, 1h, 1h15m, 4000s` etc. If no duration is
supplied the default pause duration will be used.
