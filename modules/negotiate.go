...
const (
	...
	// V142ContractNotRecognizedErrString is the string used by hosts since
	...
	V142ContractNotRecognizedErrString = "no record of that contract"
)
...
func IsContractNotRecognizedErr(err error) bool {
	...
	if strings.Contains(err.Error(), V142ContractNotRecognizedErrString) {
		return true
	}
	return false
}
