...
type PaymentProvider interface {
	...
	ProvidePayment(stream net.Conn, host types.SiaPublicKey, rpc types.Specifier, amount types.Currency, refundAccount AccountID, blockHeight types.BlockHeight) error
}
