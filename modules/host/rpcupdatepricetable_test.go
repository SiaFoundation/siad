...
func TestPriceTableMarshaling(t *testing.T) {
	pt := modules.RPCPriceTable{
		...
		DropSectorsBaseCost:  types.SiacoinPrecision.Mul64(1e8),
		DropSectorsUnitCost:  types.SiacoinPrecision.Mul64(1e8),
		WriteBaseCost:        types.SiacoinPrecision.Mul64(1e10),
		WriteLengthCost:      types.SiacoinPrecision.Mul64(1e11),
		WriteStoreCost:       types.SiacoinPrecision.Mul64(1e12),
	}
