...
type Host interface {
	...
	RegistryUpdate(rv modules.RegistryValue, pubKey types.SiaPublicKey, expiry types.BlockHeight) (bool, error)
	RegistryGet(pubKey types.SiaPublicKey, tweak crypto.Hash) ([]byte, bool)
}
