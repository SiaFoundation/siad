...
func TestHostFailedMkdirAll(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrMkdirAll{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.sm, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir))
	...
	// operation will fail.
	ht.host, err = NewCustomHost(modules.ProdDependencies, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.sm, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir))
	if err != nil {
		t.Fatal(err)
	}
}
...
func TestHostFailedNewLogger(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrNewLogger{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.sm, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir))
...
func TestHostFailedOpenDatabase(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrOpenDatabase{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.sm, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir))
...
func TestHostFailedLoadFile(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrLoadFile{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.sm, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir))
...
func TestHostFailedListen(t *testing.T) {
	...
	ht.host, err = NewCustomHost(&dependencyErrListen{}, ht.cs, ht.gateway, ht.tpool, ht.wallet, ht.sm, "localhost:0", filepath.Join(ht.persistDir, modules.HostDir))
