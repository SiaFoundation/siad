...
gitlab-runner.exe register --non-interactive --url https://gitlab.com/ --registration-token $token --executor shell --pre-clone-script "takeown /f . /r" --description Win10-Server-Hetzner --tag-list nebulous-windows
