...
// Adds one or more new ips to the gateway's blacklist
...
// Removes one or more ips from the gateway's blacklist
...
// Sets the gateway blacklist to the ips passed in
