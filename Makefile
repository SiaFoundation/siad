...
pkgs = ./build ./cmd/siac ./cmd/siad ./compatibility ./crypto ./encoding ./modules ./modules/consensus ./modules/explorer  \
       ...
       ./modules/renter/siadir ./modules/renter/siafile ./modules/miner ./modules/wallet ./modules/transactionpool         \
       ./node ./node/api ./persist ./siatest ./siatest/consensus ./siatest/daemon ./siatest/gateway ./siatest/miner        \
       ./siatest/renter ./siatest/renter ./siatest/renter/contractor ./siatest/renter/hostdb ./siatest/renterhost          \
