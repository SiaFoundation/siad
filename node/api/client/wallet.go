...
// WalletVerifyPasswordPost uses the /wallet/verifypassword endpoint to check
// the wallet's password.
func (c *Client) WalletVerifyPasswordPost(password string) (wvpg api.WalletVerifyPasswordGET, err error) {
